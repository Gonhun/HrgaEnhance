<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptTugas.aspx.cs" Inherits="HrgaEnhance.Report.RptTugas" %>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12">
                                    <rsweb:ReportViewer ID="rvTugas" runat="server" ProcessingMode="Remote" Height="760px" Width="100%" AsyncRendering="False" SizeToReportContent="True" ShowParameterPrompts="false">
                                    </rsweb:ReportViewer>
                                </div>
                            </div>
                        </div>
